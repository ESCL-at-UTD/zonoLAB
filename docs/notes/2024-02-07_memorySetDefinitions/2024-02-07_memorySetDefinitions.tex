...
\todo{Continue with this and implement the relations... that involves adding constraints that relate specific `'`dimensions'' to one another... need additional dictionary???}
